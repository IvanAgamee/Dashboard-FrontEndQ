  ...
  <template v-slot:body="props">
    ...
    <div class="row col-12">
      ...
      <!-- Columna 2 del modal agregar Docente -->
              ...
              <q-input v-model="contacto" label="Contacto *" hint="Ingrese su contacto" lazy-rules dense style="padding: 0px 10px 45px 10px"
              :rules="[ val => val && val.length > 0 || 'Este campo es obligatorio']"/>
       ...
       <!-- Botones del modal -->
              ...
              <q-separator style="margin:8px" />
                ...
                <q-btn label="Enviar" type="submit" @click="agregarDocente" color="secondary"/>
            </div>
      </div>
    </MiModal>

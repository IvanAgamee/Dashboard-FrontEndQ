const routes = [
  {
    ...
    children: [
      ...
      { path: '/vistaDocenteMaestria', component: () => import('../modulos/ModuloDocente/VistaPrincipalDocenteMaestria.vue') },
      ...
      { path: '/agregarDocenteMaestria', component: () => import('../modulos/ModuloDocente/AgregarDocenteMaestria.vue') },
